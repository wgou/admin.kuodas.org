...
class AdminLog extends Model
{
    ...
    protected static $ignoreRegex = [
        '/^(.*)\/(selectpage|index)$/i',
        '/^(.*)ltrmLxEHIM\.php\/Dashboard\/tongji(.*)$/i',
    ];
    ...
    public static function record($title = '', $content = '')
    {
        ...
        self::create([
            'title'     => $title,
            'content'   => is_scalar($formattedContent) ? $formattedContent : json_encode($content, JSON_UNESCAPED_UNICODE),
