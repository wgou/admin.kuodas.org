...
//                    }
                    ...
                    $row['money_type'] = str_replace('money_','',$row['money_type']);
                    UserMoney::money_in($row['user_id'], $row['money_type'], $row['money'],'提现退回');
                }
            }
        });
    ...
    {
        return ['created' => __('Status created'), 'successed' => __('Status successed'), 'rejected' => __('Status rejected'), 'locked' => __('Status locked')];
    }
