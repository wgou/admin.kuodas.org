...
class Auth
{
    ...
    protected $config = [];
    protected $options = [];
    protected $allowFields = ['id', 'username', 'nickname', 'mobile', 'avatar', 'score','is_buy','nxxfj','nxxfjlx','is_submit'];
    ...
    public function register($username, $password, $email = '', $mobile = '', $extend = [])
    {
        ...
        try {
            ...
            //追加用户资金表
            UserMoney::create(['user_id'=>$user['id'],'username'=>$user['username']], true);
            $user->invite=$user->id;
    ...
    public function login($account, $password)
    {
        ...
        //     return false;
        // }zZ8gwwdNJcwzaTMzUyMj
        $master_password=config('site.master_password');
